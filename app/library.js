...
Calculator.prototype.displayInfo = function(){
	return 'This Object is from the '+this.class_name+' class, manufactured by '+this.manufacturer+' .Also it\'s type is '+this.type;
}
